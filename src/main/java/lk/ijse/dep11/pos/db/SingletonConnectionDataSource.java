...
public class SingletonConnectionDataSource {
    private static SingletonConnectionDataSource instance;
    private final Connection connection;

    private SingletonConnectionDataSource(){
        try{
    ...
    public static SingletonConnectionDataSource getInstance() {
        return (instance == null) ? (instance = new SingletonConnectionDataSource()) : instance;
    }
